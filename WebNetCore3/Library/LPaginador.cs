...
namespace WebNetCore3.Library
{
    public class LPaginador<T>
    {
        ...
        private String pagi_nav_siguiente = " Siguiente &laquo; ";
        // definimos que ira en el enlace a la pagina Primero
        private String pagi_nav_primera = " &laquo; Primero ";
        private String pagi_nav_ultima = " Ultimo &laquo; ";
        private String pagi_navegacion = null;

        public object[] paginador(List<T> table, int pagina, int Registros, 
            String area, String controller, String action, String host) 
        {
            ...
            if (pagina.Equals(0))
            {
                // Si no se ha echo click a ninguna pagina especifica
            ...
            if (pagi_actual != 1)
            {
                ...
                int pagi_url = 1; //  sera el numero de la pagina al que enlazamos
